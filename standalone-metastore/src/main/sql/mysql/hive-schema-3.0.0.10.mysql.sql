...
CREATE TABLE IF NOT EXISTS `CTLGS` (
    ...
    CONSTRAINT `CTLGS_SD_FK` FOREIGN KEY (`SD_ID`) REFERENCES `SDS` (`SD_ID`) ON DELETE CASCADE ON UPDATE RESTRICT
...
CREATE TABLE IF NOT EXISTS `SD_PARAMS` (
  `SD_ID` bigint(20) NOT NULL,
  `PARAM_KEY` varchar(256) CHARACTER SET latin1 COLLATE latin1_general_cs NOT NULL,
  `PARAM_VALUE` MEDIUMTEXT CHARACTER SET latin1 COLLATE latin1_general_cs DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `TAB_COL_STATS` (
 ...
 `BIG_DECIMAL_LOW_VALUE` varchar(4000) CHARACTER SET latin1 COLLATE latin1_general_cs,
 `BIG_DECIMAL_HIGH_VALUE` varchar(4000) CHARACTER SET latin1 COLLATE latin1_general_cs,
...
CREATE TABLE IF NOT EXISTS `FUNCS` (
  ...
  `CLASS_NAME` VARCHAR(4000) CHARACTER SET latin1 COLLATE latin1_general_cs,
  `CREATE_TIME` INT(11) NOT NULL,
  `DB_ID` BIGINT(20),
  `FUNC_NAME` VARCHAR(128) CHARACTER SET latin1 COLLATE latin1_general_cs,
  `FUNC_TYPE` INT(11) NOT NULL,
  `OWNER_NAME` VARCHAR(128) CHARACTER SET latin1 COLLATE latin1_general_cs,
  `OWNER_TYPE` VARCHAR(10) CHARACTER SET latin1 COLLATE latin1_general_cs,
  PRIMARY KEY (`FUNC_ID`),
...
CREATE TABLE IF NOT EXISTS `FUNC_RU` (
  ...
  `RESOURCE_URI` VARCHAR(4000) CHARACTER SET latin1 COLLATE latin1_general_cs,
  `INTEGER_IDX` INT(11) NOT NULL,
...
CREATE TABLE `I_SCHEMA` (
  ...
  FOREIGN KEY (`DB_ID`) REFERENCES `DBS` (`DB_ID`) ON DELETE CASCADE ON UPDATE RESTRICT,
...
CREATE TABLE `SCHEMA_VERSION` (
  ...
  KEY `SIIndex` (`SCHEMA_ID`),
  KEY `SERDEIDIndex` (`SERDE_ID`),
  KEY `CDIDIndex` (`CD_ID`)
) ENGINE=NDBCLUSTER DEFAULT CHARSET=latin1;
...
-- -----------------------------------------------------------------
INSERT INTO VERSION (VER_ID, SCHEMA_VERSION, VERSION_COMMENT) VALUES (1, '3.0.0.10', 'Hive release version 3.0.0.10');
